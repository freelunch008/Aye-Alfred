...
public class ApiGatewayResponse {
    ...
    public ApiGatewayResponse(int statusCode, Map<String, String> headers, String body, boolean isBase64Encoded) {
    ...
    public static class ApiGatewayProxyResponseBuilder {
        ...
        public ApiGatewayResponse build() {
            return new ApiGatewayResponse(statusCode, headers, body, isBase64Encoded);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApiGatewayResponse)) return false;

        ApiGatewayResponse response = (ApiGatewayResponse) o;
